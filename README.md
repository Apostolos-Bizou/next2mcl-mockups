...
**Start here → [`mcl-shell-v89.html`](mcl-shell-v89.html)**
...
| File | Role |
|------|------|
| `mcl-shell-v89.html` | **MCL Shell** — the hub / entry point that launches the other apps |
| `next2peme-console-v89.html` | **Next2Peme Console** — PEME workflow console |
| `next2dms-v89.html` | **Next2DMS** — document management |
| `seafarer-360-folder-v89.html` | **Seafarer 360** — the seafarer folder view |
| `mcl-guide-v89.html` | **MCL Guide** — οδηγός χρήσης όλου του οικοσυστήματος (EL/EN) · tabs ανά app (MCL·Peme·360·DMS) + Γλωσσάριο · linked από το shell topbar · κάθε app έχει και δικό του in-app «Οδηγός» |

## Link map (how the apps talk to each other)

```
MCL Shell ──▶ Next2Peme Console
          ──▶ Next2DMS            (next2dms-v89.html?tenant=next2mcl)
          ──▶ Seafarer 360
          ──▶ MCL Guide           (mcl-guide-v89.html · topbar "📖 Guide")
