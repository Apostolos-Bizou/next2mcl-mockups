...
**Start here → [`mcl-shell-v75.html`](mcl-shell-v75.html)**
...
| File | Role |
|------|------|
| `mcl-shell-v75.html` | **MCL Shell** — the hub / entry point that launches the other apps |
| `next2peme-console-v75.html` | **Next2Peme Console** — PEME workflow console |
| `next2dms-v75.html` | **Next2DMS** — document management |
| `seafarer-360-folder-v75.html` | **Seafarer 360** — the seafarer folder view |
| `mcl-guide-v75.html` | **MCL Guide** — οδηγός χρήσης όλου του οικοσυστήματος (EL/EN) · tabs ανά app (MCL·Peme·360·DMS) + Γλωσσάριο · linked από το shell topbar · κάθε app έχει και δικό του in-app «Οδηγός» |

## Link map (how the apps talk to each other)

```
MCL Shell ──▶ Next2Peme Console
          ──▶ Next2DMS            (next2dms-v75.html?tenant=next2mcl)
          ──▶ Seafarer 360
          ──▶ MCL Guide           (mcl-guide-v75.html · topbar "📖 Guide")
